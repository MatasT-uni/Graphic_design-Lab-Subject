...
#include <time.h>
#include <stdlib.h>
#define Axes 1 // menu constants
#define NoAxes 2
#define ColorAxes 3
#define ShadeSmooth 4
#define ShadeFlat 5
int axes=1; // variables modifiable by the menus
bool shade=false;
bool flag=false;
bool axesmenu=true;
...
void initlights(void) // init lights
{
...
if (axesmenu) output_Text(-5,-35,"Axes menu");
else output_Text(-5,-35, "Shade menu");
Draw_Triangle();
glutSwapBuffers();
Time_Delay(10);
}
